...
> 最后更新：2026-07-30（安卓/iOS 详情仅循环时间；旁路：web 选择AI框群头像/默认 tab）｜图例：⬜ 未开始 · 🚧 进行中 · ✅ 完成 · ❌ 阻塞
...
| 自己消息详情 badge | — | 🚧 仅循环时间，未 commit | 🚧 仅循环时间，未 commit | ✅ 触发名+循环时间（`ff400773`） |
...
- (旁路 · web · 选择AI框) ⏳ 群头像改 `accountInfoList` 拼图 + 打开默认「全部」tab；代码已写未 commit（见 `20260707-选择AI框`）。
