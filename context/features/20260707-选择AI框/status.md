...
> 最后更新：2026-07-24（ios 底栏 SS(60)+上边距 12，缓解贴顶）｜ 图例：⬜ 未开始 · 🚧 进行中 · ✅ 完成 · ❌ 阻塞 · — 本期不做
...
> **本轮 apps 事实**（2026-07-24）：**android** 已 push `cf92a6493`；**待** 真机 E2E。**ios** 工作区未提交——底栏统一 **`SS(60)`**；`BookBottomView` 双行上边距 `8→12`、下边距 `8→10`；布局仍 `bottom=-safeH` + 描边；**待** 提交 + 真机视觉验收。**web** 干净。**desktop** 本地打包勿提交。矩阵 T8/T9/T10 仍 🚧。
