...
> 最后更新：2026-07-22（web：隐藏图标+头栏图标已 push `d289080`）｜ 图例：⬜ 未开始 · 🚧 进行中 · ✅ 完成 · ❌ 阻塞 · — 本期不做
...
- (web) ~~**列表「隐藏」菜单图标**~~：`hide.svg` 换成设计稿「隐藏 (1)」；仅 `PersonalAiChatAgentItem` 三点菜单引用。已 push `d289080`；**待** 视觉验收
