...
| 跨年文案改「两端都带年」 | ✅ 拆 timeRangeFormat.js | ✅ DateRangeTextUtil | ✅ ZXAIAgentTimeData | ✅ date-range-format.js |
| 单测 | ✅ host-bridge 9 + 区间文案 4 | — | — | ✅ 区间文案 5 |
...
- 2026-08-31 跨年区间文案改「两端都带年」（`25/12/10~26/6/26`）。旧口径每端各自判本年，
  跨年时右端落本年就不带年（`25/12/10~6/26`），终点年份要靠推断。同年区间不变，不加长。
