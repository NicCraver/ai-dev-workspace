...
4. 树节点：
   ...
   - 人员：头像 + 名
   - 表头「全部」：当前树所有人 + 所有「含团队工作」都勾上才算全选；只勾所有人是半选。点「全部」：未全选则人+所有板块一起勾上，已全选则一起清掉
...
- 2026-09-01 部门左勾选联动子孙人员（type 3）；行尾「含团队工作」单独切本板块（type 2）。左勾选态要把子树里每一项含团队工作都算进去，人齐且板块齐了才是全选；点左勾选 / 表头「全部」会把人与所有相关板块一起勾上或清掉。只勾所有人是半选
