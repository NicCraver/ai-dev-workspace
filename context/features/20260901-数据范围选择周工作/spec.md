...
4. 树节点：
   ...
   - 人员：头像 + 名
   - 表头「全部」勾当前视图所有人
   - 有报告的部门：左勾选算「子孙人 + 本行含团队工作」。只选部分人、或只勾含团队工作 → 半选；人选齐且勾了含团队工作 → 全选。点左勾选：未全选则人+板块一起勾上，已全选则一起清掉。行尾「含团队工作」仍只切本板块。
...
- 2026-09-01 部门左勾选联动子孙人员（type 3）；行尾「含团队工作」单独切本板块（type 2）。有报告的部门：左勾选态要把本板块算进去，人+板块齐了才是全选；点左勾选会把人与本板块一起勾上或清掉
