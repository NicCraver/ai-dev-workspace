...
> 最后更新：2026-07-29｜对齐 PC `MsgPersonalAiRow`（气泡下方「来自xxx个人AI框」）

## 背景与目标

群聊中个人 AI 发出的消息，`content.extra.personalAccountId` 标识归属人。PC 已在气泡**下方**展示灰底 pill：`来自{nickName}个人AI框`。本期将同一逻辑移植到 **iOS / Android**。
...
2. 用该 id 查本地用户缓存 → 命中则立刻显示 `来自{nickName}个人AI框`
